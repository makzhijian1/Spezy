...
class SelectableCircle extends StatelessWidget {
  ...
  /// widget that is displayed below the Circle for amount
  final Widget amountDescription;
  ...
  static const checkAsset = "assets/pictures/check.flr";
  static const spinningAsset = "assets/pictures/spinning.flr";
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      if (amountDescription != null) amountDescription,
    ]);
  }
